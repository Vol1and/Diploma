<template>
    <div>
        <el-row v-if=" choosing_state === 0 ">
            ...
            <el-col :span="20" :offset="2">
                <el-card class="box-card">
                    <div slot="header">
                        <h2 v-shortkey="['del']" @shortkey="deleteSelected" class="text-center">Новое перемещение
                            товаров</h2>
                    </div>
                    <el-form label-position="right">
                        ...
                        <el-row>
                            <el-col :span="4">
                                <el-form-item label="Id документа: " label-width="110px">
                            ...
                            <el-col :span="5">
                                ...
                                <el-form-item label="Дата: " label-width="70px">
                            ...
                            <el-col :span="6">
                                <el-form-item label="Склад-отправитель: " label-width="160px">
                            ...
                            <el-col :span="6">
                                <el-form-item label="Склад-получатель: " label-width="160px">
                                    <el-input readonly v-model="item.destination_storage.name" placeholder="">
        ...
        <storage-choose-component @back="onBack" v-if="choosing_state ===4"
...
export default {
    ...
    methods: {
        ...
        validateFields() {
            this.errors = [];
            if (this.item.source_storage.id === -1) this.errors.push("Поле \"Склад-отправитель\" должно быть заполнено");
            if (this.item.destination_storage.id === -1) this.errors.push("Поле \"Склад-получатель\" должно быть заполнено");
            if (this.item.destination_storage.id !== -1 && this.item.destination_storage.id === this.item.source_storage.id) this.errors.push("Склад-получатель и Склад-отправитель должны различаться");
